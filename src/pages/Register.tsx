  ...
  return (
    <div className="min-h-screen page-gradient flex flex-col items-center justify-center p-4">
      <div className="w-full max-w-5xl flex flex-col md:flex-row bg-white rounded-2xl shadow-lg overflow-hidden card-hover-lift">
        ...
        <motion.div 
          className="hidden md:block w-1/2 bg-gradient-to-br from-blue-600 to-medical-purple p-12 text-white relative overflow-hidden"
          initial={{ opacity: 0, x: 20 }}
          animate={{ opacity: 1, x: 0 }}
          ...
          <div className="relative z-10">
            ...
            >
              <h2 className="text-3xl font-display font-bold mb-6">
                Join LENY-AI's Healthcare AI Network
              </h2>
              <p className="mb-8 text-blue-100">
                Create your account to access AI-powered medical assistance and improve patient outcomes across your practice.
              </p>
            </motion.div>
