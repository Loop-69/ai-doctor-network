          ...
          <div className="container mx-auto px-6 pt-16 pb-24 md:pb-32 flex flex-col md:flex-row items-center">
            ...
            >
              ...
              <p className="text-lg text-muted-foreground mb-8 max-w-md">
                LENY-AI combines medical expertise with artificial intelligence to enhance patient care, streamline diagnostics, and improve clinical outcomes.
              </p>
        ...
        <section id="features" className="py-20 bg-white">
          <div className="container mx-auto px-6">
            <div className="text-center mb-16">
              ...
              >
                Discover how LENY-AI can transform your medical practice with cutting-edge AI capabilities
              </motion.p>
            </div>
