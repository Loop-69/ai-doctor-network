...
export const SidebarLiveCallIndicator = () => {
  ...
  // Add error handling around the component rendering
  try {
    return (
      <div 
    ...
    console.error("Error rendering SidebarLiveCallIndicator:", error);
    return null; // Return null if there's an error to prevent crashing the app
  }
};
